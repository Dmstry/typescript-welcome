...
const avarage: number = sum / numbers2.length;
// console.log('Середнє значення числе у масиві: ', avarage);
...
/*
Задача 4.
Обчислення вартості покупки з урахованням знижки.
Створити програму вартості покупки з урахуваннями знижки на основі ціни товару та величини знижки.

Декомпозиція.
1. Створити тип даних Item, який містить назу товару (name) та ціну товару (price).
...
/* 
Задача 5.
Створити програму для обчислення оплати праці співробітників на основі ставки та кількості відпрацьованих годин.
*/
...
const johnAmount: number = john.hourlyRate * 40; // сумма зарплати, яка виплачується Джону
...
/*
Задача 6.
Створити програму книжкового магазину, яка буде відображати інфрмацію про наявні книги.
*/
